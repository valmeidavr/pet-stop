            ...
            <div className="hero__panel">
              ...
              <div className="hero__panel-inner">
                ...
                <div className="hero__actions">
                  <Link to="/login" className="btn btn-orange hero__cta">
                    Entrar
                  </Link>
                  <Link
                    to="/cadastro"
      ...
      <section className="service-cards">
        <article className="service-card">
          ...
          <div className="service-card__body">
            ...
            <Link to="/paradas-pets" className="btn btn-green service-card__btn">
              Entrar
            </Link>
          </div>
        </article>
        ...
        <article className="service-card">
          ...
          <div className="service-card__body">
            ...
            <Link to="/emergencia" className="btn btn-green service-card__btn">
              Entrar
            </Link>
          </div>
        </article>
        ...
        <article className="service-card">
          ...
          <div className="service-card__body">
            ...
            <Link to="/babas" className="btn btn-green service-card__btn">
              Entrar
            </Link>
          </div>
        </article>
